...
def repair_html(text: str | None) -> tuple:
    """
...
class EvaTools:
    ...
    def _entity_filters(
        ...
        if responsible:
            filters.append(["responsible", "=", self.client.resolve_id(responsible, "CmfPerson")])
        if status:
    ...
    def search_tasks(
        ...
        try:
            ...
            tasks = self.client.list_tasks(filters=filters if filters else None, limit=limit)

            return json.dumps(
                {"success": True, "count": len(tasks), "filters": filters, "tasks": tasks},
                ensure_ascii=False,
                indent=2,
            )
            ...
            return json.dumps(
                {"success": False, "error": e.message, "code": e.code}, ensure_ascii=False, indent=2
            )
    ...
    def get_task_details(self, task_code: str) -> str:
        ...
        try:
            ...
            return json.dumps({"success": True, "task": task}, ensure_ascii=False, indent=2)
    ...
    def count_tasks_by_filter(
        ...
        try:
            ...
            return json.dumps(
                {"success": True, "count": count, "filters": filters}, ensure_ascii=False, indent=2
            )
    ...
    def create_task(
        ...
        try:
            ...
            task = self.client.create_task(
                name=name, parent=project_code, lists=lists, responsible=responsible, **kwargs
            )

            payload = {"success": True, "task": task, "message": "Task created successfully"}
            if repaired:
    ...
    def update_task(
        ...
        try:
            ...
            payload = {"success": True, "task": task, "message": "Task updated successfully"}
            if repaired:
                payload["html_unescaped"] = True
                payload["warning"] = (
                    "description arrived HTML-escaped and was unescaped before "
    ...
    def get_project_details(self, project_code: str) -> str:
        ...
        try:
            ...
            return json.dumps({"success": True, "project": project}, ensure_ascii=False, indent=2)
    ...
    def list_users(self, limit: int = 50) -> str:
        ...
        try:
            ...
            return json.dumps(
                {"success": True, "count": len(users), "users": users}, ensure_ascii=False, indent=2
            )
    ...
    def get_user_details(self, user_code: str) -> str:
        ...
        try:
            ...
            return json.dumps({"success": True, "user": user}, ensure_ascii=False, indent=2)
    ...
    def get_document_details(self, document_code: str) -> str:
        ...
        try:
            ...
            return json.dumps({"success": True, "document": document}, ensure_ascii=False, indent=2)
    ...
    def add_comment(
        ...
        try:
            ...
            if repaired:
                payload["html_unescaped"] = True
                payload["warning"] = (
                    "text arrived HTML-escaped and was unescaped before sending; " "pass raw HTML"
                )
            return json.dumps(payload, ensure_ascii=False, indent=2)
    ...
    def list_sprints(self, limit: int = 50) -> str:
        ...
        try:
            ...
            return json.dumps(
                {"success": True, "count": len(lists), "lists": lists}, ensure_ascii=False, indent=2
            )
    ...
    def create_list(self, name: str, project_code: str) -> str:
        ...
        try:
            ...
            return json.dumps(
                {"success": True, "list": created, "message": "List created successfully"},
                ensure_ascii=False,
                indent=2,
            )
    ...
    def get_sprint_details(self, list_code: str) -> str:
        ...
        try:
            ...
            return json.dumps({"success": True, "list": sprint}, ensure_ascii=False, indent=2)
    ...
    def get_audit_log(
        ...
        try:
            ...
            return json.dumps(
                {"success": True, "count": len(audit_entries), "audit_log": audit_entries},
                ensure_ascii=False,
                indent=2,
            )
